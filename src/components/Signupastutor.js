...
class Signupastutor extends Component {
    state = {  }
    render() { 
        return (
            <div className="row" id="signup">
                <div className="col s12 m12 l6" id="signupleft">
                    <div className="col s12 m12 l6 offset-l6">
                        ...
                        <p className="center-align">Register here. Create a Profile. Provide your Experties, 
                            Qualification, Experiance and other data. Find Tuitions and Become a Tutor.</p>
                    </div>
                </div>
